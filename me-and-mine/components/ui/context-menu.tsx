/**
 * ContextMenu - Web fallback
 * On web, long-press shows a tooltip indicating native menu is available.
 * On iOS/Android, the platform-specific files render the real native context menu.
 */

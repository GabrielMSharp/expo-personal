/**
 * BlurView - Android native implementation
 * Uses expo-blur for blur effects (with Android limitations).
 */
...
const tintMap: Record<BlurIntensity, 'light' | 'dark' | 'default'> = {
  light: 'light',
  default: 'default',
  dark: 'dark',
  prominent: 'dark', // Android doesn't have prominent, fallback to dark
};

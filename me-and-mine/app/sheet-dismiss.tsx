...
export default function SheetDismissScreen() {
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: sheetBackground }]} edges={['bottom']}>
      ...
      >
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: textColor }]}>Dismiss Only Preset</Text>
          <Text style={[styles.description, { color: secondaryTextColor }]}>
            This sheet has a dismiss (X) button on the left side of the header. Tap it or swipe down to close.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={[styles.card, { backgroundColor: cardBackground }]}>
            ...
            <InfoRow label="Header Right" value="None" textColor={textColor} secondaryColor={secondaryTextColor} />
            <InfoRow label="Detents" value="50%, 100%" textColor={textColor} secondaryColor={secondaryTextColor} />
